...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.data_set_combo = QtWidgets.QComboBox(self.layoutWidget)
        self.data_set_combo.setObjectName("data_set_combo")
        self.data_set_combo.addItem("")
        self.verticalLayout.addWidget(self.data_set_combo)
        ...
        self.tree_view = QtWidgets.QTreeView(self.layoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.data_set_combo.setItemText(0, _translate("MainWindow", "[None]"))

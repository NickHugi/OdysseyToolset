...
# Form implementation generated from reading ui file 'encounter_editor.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tree.topLevelItem(0).child(2).setText(0, _translate("Form", "Difficulty"))
        self.tree.topLevelItem(0).child(3).setText(0, _translate("Form", "Faction"))
        self.tree.topLevelItem(0).child(4).setText(0, _translate("Form", "Min Creatures"))
        self.tree.topLevelItem(0).child(5).setText(0, _translate("Form", "Max Creatures"))
        self.tree.topLevelItem(0).child(6).setText(0, _translate("Form", "Interval"))
        self.tree.topLevelItem(0).child(7).setText(0, _translate("Form", "Waves"))
        ...
        self.tree.topLevelItem(2).setText(0, _translate("Form", "Flags"))
        self.tree.topLevelItem(2).child(0).setText(0, _translate("Form", "Active"))
        ...
        self.tree.topLevelItem(3).child(3).setText(0, _translate("Form", "All Dead"))
        self.tree.topLevelItem(3).child(4).setText(0, _translate("Form", "Custom"))
        self.tree.topLevelItem(4).setText(0, _translate("Form", "Creatures"))

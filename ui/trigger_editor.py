...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tree.topLevelItem(0).child(2).setText(0, _translate("Form", "Faction"))
        self.tree.topLevelItem(0).child(3).setText(0, _translate("Form", "Type"))
        self.tree.topLevelItem(0).child(4).setText(0, _translate("Form", "Cursor"))
        ...
        self.tree.topLevelItem(2).child(3).setText(0, _translate("Form", "Clicked"))
        self.tree.topLevelItem(2).child(4).setText(0, _translate("Form", "Disarmed"))
        self.tree.topLevelItem(2).child(5).setText(0, _translate("Form", "Triggered"))
        self.tree.topLevelItem(2).child(6).setText(0, _translate("Form", "Custom"))
        self.tree.topLevelItem(3).setText(0, _translate("Form", "Trap"))

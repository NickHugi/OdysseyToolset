...
# Form implementation generated from reading ui file 'waypoint_editor.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tree.topLevelItem(0).child(2).setText(0, _translate("Form", "Map Note"))
        self.tree.topLevelItem(0).child(3).setText(0, _translate("Form", "Note Active"))
        ...
        self.tree.topLevelItem(2).setText(0, _translate("Form", "Map Note"))

...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tree.topLevelItem(0).child(2).setText(0, _translate("Form", "Elevation"))
        self.tree.topLevelItem(0).child(3).setText(0, _translate("Form", "Interval"))
        self.tree.topLevelItem(0).child(4).setText(0, _translate("Form", "Volume"))
        self.tree.topLevelItem(0).child(5).setText(0, _translate("Form", "Interval Variation"))
        self.tree.topLevelItem(0).child(6).setText(0, _translate("Form", "Volume Variation"))
        ...
        self.tree.topLevelItem(2).child(2).setText(0, _translate("Form", "Y Variation"))
        self.tree.topLevelItem(3).setText(0, _translate("Form", "Flags"))
        self.tree.topLevelItem(3).child(0).setText(0, _translate("Form", "Active"))
        self.tree.topLevelItem(3).child(1).setText(0, _translate("Form", "Continuous"))
        self.tree.topLevelItem(3).child(2).setText(0, _translate("Form", "Looping"))
        self.tree.topLevelItem(3).child(3).setText(0, _translate("Form", "Positional"))
        self.tree.topLevelItem(3).child(4).setText(0, _translate("Form", "Random Position"))
        self.tree.topLevelItem(3).child(5).setText(0, _translate("Form", "Random Order"))
        self.tree.topLevelItem(4).setText(0, _translate("Form", "Playlist"))

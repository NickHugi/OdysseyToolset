...
class TriggerEditor(AbstractTreeEditor):
    ...
    def load(self, utw):
        ...
        self.set_node_data("Basic", "Type", utw.find_field_data("Type", default=0))
        self.set_node_data("Basic", "Cursor", utw.find_field_data("Cursor", default=0))
        ...
        self.set_node_data("Scripting", "Clicked", utw.find_field_data("OnClick", default=""))
        self.set_node_data("Scripting", "Disarmed", utw.find_field_data("OnDisarm", default=""))
        self.set_node_data("Scripting", "Triggered", utw.find_field_data("OnTrapTriggered", default=0))

...
class SoundEditor(AbstractTreeEditor):
    ...
    def load(self, utw):
        ...
        self.set_note_data("Basic", "Elevation", utw.find_field_data("Elevation", default=0))
        self.set_note_data("Basic", "Interval", utw.find_field_data("Interval", default=0))
        self.set_note_data("Basic", "Interval Variation", utw.find_field_data("IntervalVrtn", default=0))
        self.set_note_data("Basic", "Volume", utw.find_field_data("Volume", default=0))
        self.set_note_data("Basic", "Volume Variation", utw.find_field_data("VolumeVrtn", default=0))
        self.set_note_data("Basic", "Pitch Variation", utw.find_field_data("PitchVariation", default=0))
        self.set_note_data("Basic", "Min Distance", utw.find_field_data("MinDistance", default=0))
        self.set_note_data("Basic", "Max Distance", utw.find_field_data("MaxDistance", default=0))

        self.set_note_data("Advanced", "Priority", utw.find_field_data("Priority", default=0))
        self.set_note_data("Advanced", "X Variation", utw.find_field_data("RandomRangeX", default=0))
        self.set_note_data("Advanced", "Y Variation", utw.find_field_data("RandomRangeY", default=0))

        self.set_note_data("Flags", "Active", utw.find_field_data("Active", default=0))
        self.set_note_data("Flags", "Continuous", utw.find_field_data("Continuous", default=0))
        self.set_note_data("Flags", "Looping", utw.find_field_data("Looping", default=0))
        self.set_note_data("Flags", "Positional", utw.find_field_data("Positional", default=0))
        self.set_note_data("Flags", "Random Position", utw.find_field_data("RandomPosition", default=0))
        self.set_note_data("Flags", "Random Order", utw.find_field_data("Random", default=0))

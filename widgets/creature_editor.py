...
class CreatureEditor(AbstractTreeEditor):
    ...
    def load(self, utc):
        self.set_note_data("Skills", "Computer Use", utc.find_field_data("SkillList", 0, "Rank", default=0))
        self.set_note_data("Skills", "Demolitions", utc.find_field_data("SkillList", 1, "Rank", default=0))
        self.set_note_data("Skills", "Stealth", utc.find_field_data("SkillList", 2, "Rank", default=0))
        self.set_note_data("Skills", "Awareness", utc.find_field_data("SkillList", 3, "Rank", default=0))
        self.set_note_data("Skills", "Persuade", utc.find_field_data("SkillList", 4, "Rank", default=0))
        self.set_note_data("Skills", "Repair", utc.find_field_data("SkillList", 5, "Rank", default=0))
        self.set_note_data("Skills", "Security", utc.find_field_data("SkillList", 6, "Rank", default=0))
        self.set_note_data("Skills", "Treat Injury", utc.find_field_data("SkillList", 7, "Rank", default=0))

        self.set_note_data("Basic", "Script Tag", utc.find_field_data("Tag", default=""))
        self.set_note_data("Basic", "Template", utc.find_field_data("TemplateResRef", default=""))
        self.set_note_data("Basic", "Appearance", utc.find_field_data("Appearance_Type", default=0))
        self.set_note_data("Basic", "Body Bag", utc.find_field_data("BodyBag", default=0))
        self.set_note_data("Basic", "Dialog", utc.find_field_data("Conversation", default=0))
        self.set_note_data("Basic", "Alignment", utc.find_field_data("GoodEvil", default=0))
        self.set_note_data("Basic", "Class", utc.find_field_data("ClassList", 0, "Class", default=0))
        self.set_note_data("Basic", "Level", utc.find_field_data("ClassList", 0, "ClassLevel", default=0))
        self.set_note_data("Basic", "Alignment", utc.find_field_data("ClassList", 0, "Class", default=0))

        self.set_note_data("Advanced", "Faction", utc.find_field_data("FactionID", default=4))
        self.set_note_data("Advanced", "Gender", utc.find_field_data("Gender", default=0))
        self.set_note_data("Advanced", "Perception", utc.find_field_data("PerceptionRange", default=8)-8)  # starts at index 8
        self.set_note_data("Advanced", "Phenotype", utc.find_field_data("Phenotype", default=0))
        self.set_note_data("Advanced", "Race", utc.find_field_data("Race", default=6)-5)  # starts at index 5
        self.set_note_data("Advanced", "Subrace", utc.find_field_data("SubraceIndex", default=0))
        self.set_note_data("Advanced", "Soundset", utc.find_field_data("SoundSetFile", default=0))
        self.set_note_data("Advanced", "Speed", utc.find_field_data("WalkRate", default=0))

        self.set_note_data("Attributes", "Strength", utc.find_field_data("Str", default=0))
        self.set_note_data("Attributes", "Dexterity", utc.find_field_data("Dex", default=0))
        self.set_note_data("Attributes", "Constitution", utc.find_field_data("Con", default=0))
        self.set_note_data("Attributes", "Intelligence", utc.find_field_data("Int", default=0))
        self.set_note_data("Attributes", "Charisma", utc.find_field_data("Cha", default=0))
        self.set_note_data("Attributes", "Wisdom", utc.find_field_data("Wis", default=0))

        self.set_note_data("Scripts", "Attacked Physical", utc.find_field_data("ScriptAttacked", default=0))
        self.set_note_data("Scripts", "Damaged", utc.find_field_data("ScriptDamaged", default=0))
        self.set_note_data("Scripts", "Death", utc.find_field_data("ScriptDeath", default=0))
        self.set_note_data("Scripts", "Before Talking", utc.find_field_data("ScriptDialogue", default=0))
        self.set_note_data("Scripts", "Inventory Changed", utc.find_field_data("ScriptDisturbed", default=0))
        self.set_note_data("Scripts", "After Talking", utc.find_field_data("ScriptEndDialogu", default=0))
        self.set_note_data("Scripts", "Round Ended", utc.find_field_data("ScriptEndRound", default=0))
        self.set_note_data("Scripts", "Routine", utc.find_field_data("ScriptHeartbeat", default=0))
        self.set_note_data("Scripts", "Blocked", utc.find_field_data("ScriptOnBlocked", default=0))
        self.set_note_data("Scripts", "Detected", utc.find_field_data("ScriptOnNotice", default=0))
        self.set_note_data("Scripts", "Spawned", utc.find_field_data("ScriptSpawn", default=0))
        self.set_note_data("Scripts", "Attacked Ability", utc.find_field_data("ScriptSpellAt", default=0))
        self.set_note_data("Scripts", "Routine", utc.find_field_data("ScriptUserDefine", default=0))

        self.set_note_data("Flags", "Disarmable", utc.find_field_data("Disarmable", default=0))
        self.set_note_data("Flags", "Interruptable", utc.find_field_data("Interruptable", default=0))
        self.set_note_data("Flags", "Is PC", utc.find_field_data("IsPC", default=0))
        self.set_note_data("Flags", "Invincible", utc.find_field_data("Min1HP", default=0))
        self.set_note_data("Flags", "Doesn't Die", utc.find_field_data("NoPermDeath", default=0))
        self.set_note_data("Flags", "Doesn't Face PC", utc.find_field_data("NotReorienting", default=0))
        self.set_note_data("Flags", "Interactable", utc.find_field_data("PartyInteract", default=0))
        self.set_note_data("Flags", "Plot", utc.find_field_data("Plot", default=0))

        self.set_note_data("Other", "Challenge Rating", utc.find_field_data("ChallengeRating", default=0))
        self.set_note_data("Other", "Health", utc.find_field_data("MaxHitPoints", default=0))
        self.set_note_data("Other", "Force", utc.find_field_data("ForcePoints", default=0))
        self.set_note_data("Other", "Fortitude", utc.find_field_data("fortbonus", default=0))
        self.set_note_data("Other", "Reflex", utc.find_field_data("refbonus", default=0))
        self.set_note_data("Other", "Will", utc.find_field_data("willbonus", default=0))
        self.set_note_data("Other", "Natural AC", utc.find_field_data("NaturalAC", default=0))
